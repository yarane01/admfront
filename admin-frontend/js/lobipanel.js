...
//------------------------------------------------------------------------------
            ...
            var maxWidth = 'calc(100% - '+$heading.find('.lobi-menu').children().length * $heading.find('.lobi-menu li').first().outerWidth()+"px)";
        ...
        var _generateControls = function(){
            ...
            var menu = dropdown.find('.lobi-menu');
        ...
        var _generateDropdown = function(){
            return $('<div class="lobi-dropdown dropdown"></div>')
                    .append('<ul class="lobi-menu dropdown-menu dropdown-menu-right"></ul>')
        ...
        this.minimize = function(){
            ...
            if (me.isPinned()) {
                ...
                me.$el.animate({
                    ...
                    var maxWidth = 'calc(100% - '+$heading.find('.lobi-menu li>a:visible').length * $heading.find('.lobi-menu li>a:visible').first().outerWidth()+"px)";
                    $heading.find('.panel-title').css('max-width', maxWidth);
...
//            css['position'] = 'absolute';
                ...
                me.$el.animate(css, 100, function () {
                    ...
                    var maxWidth = 'calc(100% - ' + $heading.find('.lobi-menu li').length * $heading.find('.lobi-menu li').first().outerWidth() + "px)";
                    $heading.find('.panel-title').css('max-width', maxWidth);
                    _saveState('unpinned');
...
*/
        ...
        this.enableTooltips = function () {
            ...
            var controls = $heading.find('.lobi-menu>li>a');
        ...
        this.disableTooltips = function(){
            $heading.find('.lobi-menu>li>a').tooltip('destroy');
            return me;
        };
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
